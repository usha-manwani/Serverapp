...
namespace Cresij_Control_Manager
{
    ...
    public class Pools
    {
        ...
        public Pools(string ip, Socket sokConnection, Thread thr, DateTime now, int port)
        {
            _ip = ip;
            _sock = sokConnection;
            _dt = now;
    ...
    public class WorkingHours
    {
        ...
        public WorkingHours(string mac)
        {
            ...
            try
            {
                if (this.MacAddress == data[0])
                {
                    ...
                    if (projectorhour > 2 || computerhour > 2 || recorderhour > 2 || achour > 2 || cchour > 2 || screenhour > 2)
                    {
                        ...
                        string q = query.InsertWorkingHour(this.MacAddress, Math.Round(projectorhour / 60, 2),
